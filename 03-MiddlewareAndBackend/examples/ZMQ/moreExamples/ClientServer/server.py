...
# type. In our case, we are supporting the role of a server, which technically means
# that we are going to reply to incoming client requests. Thus, the REP type
# is to be used for the socket type
...
# use TCP protocol, the * implies any available interface, and 5555 is the port num

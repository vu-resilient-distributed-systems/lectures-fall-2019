...
## Modified by Abhishek Dubey -- 8/18/2018
#
# This work is licensed under a Creative Commons Attribution 3.0 Unported License.
# See: http://creativecommons.org/licenses/by/3.0/
"""
This example prgoram explains on how to create UDP sockets, send data using the created sockets,
and also to listen to incoming messages. It can be seen from this example that the socket which 
wants to send the data has to bind itself to an IP address and a port number associated. The
sockets which intends to listen to data connects to the same IP address.

In addition to the creation of sockets, sending/ receiving messages, you can also see the functions
where the sockets can associate themselves to a multicast group. IP Multicast is a method of sending 
data to a group of interested listeners. So all the sockets which are interested on listening to a 
socket can get associated with the multicast group."""
